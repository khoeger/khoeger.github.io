...
- It might help if I make a plan for a future Genuary, especially once I have more outside responsibilities. The plan would probably need to include
    ...
    - a documenting plan 
    - a writeup /recap plan - notice that this post has been released far after January, and that it might be nice to write something about each prompt while it is all fresh in mind in the future. perhaps take a page out of [Illest Preacha's](https://blog.illestpreacha.com/genuary2023remix) book and write small blog post each day.
