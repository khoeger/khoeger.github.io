...
The process from the [Reconstituted Media]({% link _projects_list/reconstituted-media.markdown %}) Project's image constrution was used to create this image. 
...
I tended not to have access to many colors, sometimes drew flowers such as the ones pictured, and never drew completely regularly. 
While I do not have a child, this is similar output to what I could have drawn when I was trying extremely hard to draw flowers. 
